const SEARCH_INDEX = [
  ...
  { title: 'Cheatsheet corporativo', path: 'corporate-cheatsheet.html', text: 'cheatsheet corporativo scorecard handoff guardrails dominio suporte sre incidentes finanças people ops showback ownership governança custos métricas operação multiagente' },
  ...
  { title: '33. Custos em produção', path: 'chapters/33-custos-em-producao-e-planejamento.html', text: 'custos produção orçamento budget tiering modelos planejamento finops custo por tarefa percentual premium custo ajustado retrabalho humano limites alertas kill switch contexto retries guardrails capacidade squads showback chargeback subalocação excesso de contexto budget mal calibrado portfolio dominios ownership financeiro agentes por dominio' },
